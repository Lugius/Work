...
?>
<div id="toolbar" class="toolbar" style="width:80%;margin-left:14%;">
<div class="m m1">
...
<li><a href="ganancias.php"><img src="gastos.png" /><br />Informe de ventas</a></li>
...
<?php
	...
	$condicion="enabled='1'";
	$display_adicional="";
	if(isset($_GET['fecha_amortizacion'])){
		$partesfecha=explode("-",$_GET['fecha_amortizacion']);
		$condicion="enabled=0 and fecha like '".($partesfecha[1]."/".$partesfecha[2]."/".substr($partesfecha[0],0,2))."%'";
		$display_adicional=" (".($partesfecha[1]."/".$partesfecha[2]."/".substr($partesfecha[0],0,2)).")";
	}
