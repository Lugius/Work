...
$query="INSERT INTO ".$database.".`cat_tipo_compra` 
(`id`, `nombre`, `descripcion`, `icono`, `icono_path`) VALUES 
('1', 'Virtual', 'Compra virtual', 'car.png', './images/15d462f5c0c57cc9882bded5591aa9ff');
INSERT INTO ".$database.".`cat_tipo_compra` 
(`id`, `nombre`, `descripcion`, `icono`, `icono_path`) VALUES 
('2', 'Real', 'Compra real', 'ClienteReal.png', './images/74f8d46348773e5460e07c406cf4101e');
INSERT INTO ".$database.".`cat_tipo_compra` 
(`id`, `nombre`, `descripcion`, `icono`, `icono_path`) VALUES 
('3', 'Prestado 50%', 'Pr&eacute;stamo mercancia 50%', 'EnPrestamo-31.png', './images/6f3831d7a2f5ad1cc822ef951a1c234f;";
if (mysql_query($query, $link)) {
    echo "Tabla creada satisfactoriamente!\n";
} else {
    echo 'Error creando base de datos: ' . mysql_error() . "\n";
...
$query="INSERT INTO ".$database.".`cat_tipo` 
(`id`, `nombre`, `descripcion`) VALUES 
('1', 'Mineral nativo', 'Minerales formados por un solo elemento qu&iacute;mico');
INSERT INTO ".$database.".`cat_tipo` 
(`id`, `nombre`, `descripcion`) VALUES 
('2', 'Haluros', 'Minerales formados por combinaciones del fl&uacute;or, cloro, bromo o yodo con distintos metales.');
INSERT INTO ".$database.".`cat_tipo` 
(`id`, `nombre`, `descripcion`) VALUES 
('3', 'Minerales ciclosilicatos', 'Minerales de la clase silicatos compuestos por 
	&aacute;tomos de silicio y ox&iacute;geno unidos por enlace covalente, con uniones 
	i&oacute;nicas con cationes muy diversos, produciendo los distintos minerales que componen esta familia.');";
if (mysql_query($query, $link)) {
    echo "Tabla creada satisfactoriamente!\n";
} else {
    echo 'Error creando base de datos: ' . mysql_error() . "\n";
...
$query="INSERT INTO ".$database.".`categorias` 
(`id`, `nombre`, `descripcion`, `tipo`, `imagen`, `imagen_path`) VALUES 
('1', 'Gema', '', '3', 'Gema.png', './images/c50743bfe54584401c4e0adf1332f4db');
INSERT INTO ".$database.".`categorias` 
(`id`, `nombre`, `descripcion`, `tipo`, `imagen`, `imagen_path`) VALUES 
('2', 'Mineral', '', '3', 'mineral_icon.jpg', './images/53036a2282bb9e58177c40a90dc417e0');";
if (mysql_query($query, $link)) {
    echo "Tabla creada satisfactoriamente!\n";
} else {
    echo 'Error creando base de datos: ' . mysql_error() . "\n";
...
$query="INSERT INTO ".$database.".`cat_tipo_estado_venta` 
(`id`, `nombre`, `descripcion`, `icono`, `icono_path`) VALUES 
('1', 'Vendido', 'Venta terminada', 'vendido.png', './images/d7e770ee1fe5eb31a5fd895a177b14ba');
INSERT INTO ".$database.".`cat_tipo_estado_venta` 
(`id`, `nombre`, `descripcion`, `icono`, `icono_path`) VALUES 
('2', 'Pendiente', 'Venta pendiente', 'pendiente.png', './images/8a1e2be6640cb78d2f88a62d7716f280');
INSERT INTO ".$database.".`cat_tipo_estado_venta` 
(`id`, `nombre`, `descripcion`, `icono`, `icono_path`) VALUES 
('3', 'Cancelado', 'Venta cancelada', 'cancelado.png', './images/609c4ad1f96964fdbed5485e1c61f09e');";
if (mysql_query($query, $link)) {
    echo "Tabla creada satisfactoriamente!\n";
} else {
    echo 'Error creando base de datos: ' . mysql_error() . "\n";
...
$query="INSERT INTO ".$database.".`cat_tipo_venta` 
(`id`, `nombre`, `descripcion`) VALUES 
('1', 'F&iacute;sica', 'Compra f&iacute;sica');
INSERT INTO ".$database.".`cat_tipo_venta` 
(`id`, `nombre`, `descripcion`) VALUES 
('2', 'Internet', 'Compra por internet');";
if (mysql_query($query, $link)) {
    echo "Tabla creada satisfactoriamente!\n";
} else {
    echo 'Error creando base de datos: ' . mysql_error() . "\n";
